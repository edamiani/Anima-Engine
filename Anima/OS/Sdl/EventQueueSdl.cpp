...
namespace AE
{
	namespace OS
	{
		...
		LRESULT WINAPI EventQueueSdl::MsgProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
		{
			AE::OS::WindowSdl *window = reinterpret_cast<AE::OS::WindowSdl *>(::GetWindowLongPtr(hWnd, GWLP_USERDATA));
			switch(msg)
			{
				case WM_CHAR:
				{
		...
		AE::OS::Event* EventQueueSdl::_translateEvent(UINT msg)
		{
