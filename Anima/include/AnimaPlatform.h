...
#if defined(__x86_64__) || defined (__amd64__) || defined(_M_X64) || defined(__powerpc64__) || defined(__alpha__) || defined(__ia64__) || defined(__s390__) || defined(__s390x__)
...
extern "C"
{
	...
	#include "AnimaPlatformWin32.h"
#endif

#ifdef AE_PLATFORM_LINUX
	#include "AnimaPlatformLinux.h"
#endif

#ifdef AE_PLATFORM_OSX
	#include "AnimaPlatformOSX.h"
#endif
