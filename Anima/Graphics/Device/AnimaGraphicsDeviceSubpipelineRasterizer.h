#ifndef __AE_GRAPHICS_DEVICE_SUBPIPELINE_RASTERIZER__
#define __AE_GRAPHICS_DEVICE_SUBPIPELINE_RASTERIZER__
...
namespace AE
{
	namespace Graphics
	{
		namespace Device
		{
			class SubpipelineRasterizer : public AE::Graphics::Device::Subpipeline
			{
			public:
				SubpipelineRasterizer(AE::Graphics::Device::SubpipelineType subpipelineType, AE::Graphics::Device::Pipeline *parentPipeline) : Subpipeline(subpipelineType, parentPipeline) {}
				~SubpipelineRasterizer() {}
