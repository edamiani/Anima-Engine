#ifndef __AE_GRAPHICS_DEVICE_SUBPIPELINE_RASTERIZER_GL21__
#define __AE_GRAPHICS_DEVICE_SUBPIPELINE_RASTERIZER_GL21__

#include "AnimaGraphicsDeviceSubpipelineRasterizer.h"

#include "AnimaGraphicsDeviceStageRasterizerGL21.h"
...
namespace AE
{
	namespace Graphics
	{
		namespace Device
		{
			class SubpipelineRasterizerGL21 : public AE::Graphics::Device::SubpipelineRasterizer
			{
			public:
				SubpipelineRasterizerGL21(AE::Graphics::Device::SubpipelineType subpipelineType, AE::Graphics::Device::Pipeline *parentPipeline) : SubpipelineRasterizer(subpipelineType, parentPipeline) {}
				~SubpipelineRasterizerGL21() {}
			...
			protected:
				AE::Graphics::Device::StageRasterizerGL21	*mStageRasterizer;
