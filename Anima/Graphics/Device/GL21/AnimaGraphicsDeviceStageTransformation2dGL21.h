#ifndef __AE_GRAPHICS_DEVICE_STAGE_TRANSFORMATION2D_GL21__
#define __AE_GRAPHICS_DEVICE_STAGE_TRANSFORMATION2D_GL21__

#include "AnimaGraphicsDeviceStage.h"

#include "AnimaGraphicsDeviceStageTransformation2dGL21.h"
...
namespace AE
{
	namespace Graphics
	{
		...
		namespace Device
		{
			...
			class StageTransformation2dGL21 : public AE::Graphics::Device::Stage
			{
			public:
				StageTransformation2dGL21(AE::Graphics::Device::Subpipeline *parentSubpipeline);
				~StageTransformation2dGL21();
