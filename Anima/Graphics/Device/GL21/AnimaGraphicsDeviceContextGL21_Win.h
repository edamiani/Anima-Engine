#ifndef __AE_GRAPHICS_DEVICE_CONTEXT_GL21_WIN__
#define __AE_GRAPHICS_DEVICE_CONTEXT_GL21_WIN__
...
namespace AE
{
	namespace Graphics
	{
		namespace Device
		{
			class ContextGL21 : public AE::Graphics::Device::Context
			{
			public:
				ContextGL21(AE::Graphics::Device::ContextDesc &contextDesc, AE::Graphics::Device::Driver *deviceDriver);
				virtual ~ContextGL21();
