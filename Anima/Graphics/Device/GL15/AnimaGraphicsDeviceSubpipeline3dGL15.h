#ifndef __AE_GRAPHICS_DEVICE_SUBPIPELINE_3D_GL15__
#define __AE_GRAPHICS_DEVICE_SUBPIPELINE_3D_GL15__

#include "Anima/Graphics/Device/AnimaGraphicsDeviceSubpipeline3d.h"
...
namespace AE
{
	namespace Graphics
	{
		namespace Device
		{
			class Subpipeline3dGL15 : public AE::Graphics::Device::Subpipeline3d
			{
			public:
				Subpipeline3dGL15(AE::Graphics::Device::SubpipelineType subpipelineType, AE::Graphics::Device::Pipeline *parentPipeline) : Subpipeline3d(subpipelineType, parentPipeline) {}
				~Subpipeline3dGL15() {}
