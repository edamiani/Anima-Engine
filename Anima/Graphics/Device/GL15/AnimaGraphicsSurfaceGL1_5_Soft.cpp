...
namespace AE
{
	namespace Graphics
	{
		...
		SurfaceGL1_5::SurfaceGL1_5(const AE::Graphics::SurfaceDesc &surfaceDesc)
			: AE::Graphics::Surface(surfaceDesc.dimensions)
		{
			mIsOffScreen = true;
			...
			case SF_A8R8G8B8:
				...
				mBlitFunctor = new BlitFunctorGL1_5(this, &AE::Graphics::SurfaceGL1_5::_blitAlpha);
				mBlitFromSurfaceFunctor = new BlitFromSurfaceFunctorGL1_5(this, &AE::Graphics::SurfaceGL1_5::_blit);
				break;
			case SF_X8R8G8B8:
				mPixelFormatGL = GL_BGRA;
				mTypeGL = GL_UNSIGNED_INT_8_8_8_8_REV;
				...
				mBlitFunctor = new BlitFunctorGL1_5(this, &AE::Graphics::SurfaceGL1_5::_blitNoAlpha);
				mBlitFromSurfaceFunctor = new BlitFromSurfaceFunctorGL1_5(this, &AE::Graphics::SurfaceGL1_5::_blit);
				break;
			case SF_R8G8B8A8:
			...
			if(surfaceDesc.data != 0)
				mSurfaceGL = surfaceDesc.data;
			else
				mSurfaceGL = static_cast<GLbyte *>(malloc(mDimensions.x * mDimensions.y * (mPixelFormat.colorDepth / 8)));
		...
		void SurfaceGL1_5::blit(AE::Graphics::Surface *sourceSurface, const AE::Math::Point2 &dimensions, const AE::Math::Point2 &position)
		{
			(*mBlitFromSurfaceFunctor)(sourceSurface, dimensions, position);
		}

		void SurfaceGL1_5::blit(void *source, const AE::Math::Point2 &dimensions, const AE::Math::Point2 &position)
		{
			(*mBlitFunctor)(source, dimensions, position);
		}

		void SurfaceGL1_5::_blit(AE::Graphics::Surface *sourceSurface, const AE::Math::Point2 &dimensions, const AE::Math::Point2 &position)
		{
		...
		void SurfaceGL1_5::_blitAlpha(void *source, const AE::Math::Point2 &dimensions, const AE::Math::Point2 &position)
		{
		...
		void SurfaceGL1_5::_blitNoAlpha(void *source, const AE::Math::Point2 &dimensions, const AE::Math::Point2 &position)
		{
		...
		void SurfaceGL1_5::plot(const AE::Graphics::Color &color, const AE::Math::Point2 &position)
		{
			if(mPixelFormat.colorDepth == 16)
			{
		...
		void SurfaceGL1_5::plot32(const AE::uint32 color, const AE::Math::Point2 &position)
		{
