...
#include "AnimaGraphicsDeviceStageTransformation2dGL1_5.h"
...
namespace AE
{
	namespace Graphics
	{
		...
		namespace Device
		{
			...
			class StageTransformation2dGL1_5 : public AE::Graphics::Device::Stage
			{
			public:
				StageTransformation2dGL1_5(AE::Graphics::Device::Subpipeline *parentSubpipeline);
				~StageTransformation2dGL1_5();
