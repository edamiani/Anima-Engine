...
namespace AE
{
	namespace Graphics
	{
		namespace Device
		{
			PixelBufferGL1_5::PixelBufferGL1_5(const AE::Graphics::Device::PixelBufferDesc &pixelBufferDesc) :
				AE::Graphics::Device::PixelBuffer(pixelBufferDesc)
			{
				...
				case CF_R8G8B8:
					...
					break;
				default:
					throw AE::Exception(AE::ET_NOT_FOUND, "AE::Graphics::Device::PixelBufferGL1_5::PixelBufferGL1_5(): Image doesn't have a supported color format");
				}
			...
			PixelBufferGL1_5::~PixelBufferGL1_5()
			{
				//glDeleteBuffers(1, &mPixelBufferGL);
				glDeleteTextures(1, &mTextureGL);
			}

			void PixelBufferGL1_5::blitFrom(AE::Graphics::ColorBuffer *source, AE::Math::Point2<AE::uint> srcOffset, AE::Math::Point2<AE::uint> srcDimensions, AE::Math::Point2<AE::int32> const &destPosition)
			{
				...
				glTexSubImage2D(GL_TEXTURE_2D, 0, 
								...
								static_cast<AE::Graphics::Device::PixelBufferGL1_5 *>(source)->mPixelFormatGL, 
								static_cast<AE::Graphics::Device::PixelBufferGL1_5 *>(source)->mTypeGL, 
								pixels);
