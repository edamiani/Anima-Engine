...
#include "../include/AnimaGraphicsDevicePipelineGL15.h"
#include "../include/AnimaGraphicsDeviceFrameBufferGL15.h"
#include "../include/AnimaGraphicsDevicePixelBufferDesc.h"
#include "../include/AnimaGraphicsDeviceStageInput2dGL15.h"
	...
	namespace Graphics
	{
		namespace Device
		{
				...
				: Context(deviceDriver)
			{
				...
				//static_cast<AE::Graphics::Device::ManagerGL15 *>(AE::Graphics::Device::Manager::getInstance())->_initializeExtensions();
