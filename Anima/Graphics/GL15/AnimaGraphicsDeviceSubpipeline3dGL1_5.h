#ifndef __AE_GRAPHICS_DEVICE_SUBPIPELINE_3D_GL1_5__
#define __AE_GRAPHICS_DEVICE_SUBPIPELINE_3D_GL1_5__
...
namespace AE
{
	namespace Graphics
	{
		namespace Device
		{
			class Subpipeline3dGL1_5 : public AE::Graphics::Device::Subpipeline3d
			{
			public:
				Subpipeline3dGL1_5(AE::Graphics::Device::SubpipelineType subpipelineType, AE::Graphics::Device::Pipeline *parentPipeline) : Subpipeline3d(subpipelineType, parentPipeline) {}
				~Subpipeline3dGL1_5() {}
