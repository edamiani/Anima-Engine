...
#include "../include/AnimaGraphicsGeometryFactoryAE.h"
...
namespace AE
{
	namespace Graphics
	{
		namespace TwoD
		{
			GeometryFactoryAE::GeometryFactoryAE()
			{
			}
			...
			void GeometryFactoryAE::drawArc(const AE::Graphics::GeometryDescArc &geometryDesc)
			{
			...
			void GeometryFactoryAE::drawCircle(const AE::Graphics::GeometryDescCircle &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
			...
			void GeometryFactoryAE::drawDonut(const AE::Graphics::GeometryDescDonut &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
			...
			void GeometryFactoryAE::drawEllipse(const AE::Graphics::GeometryDescEllipse &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
			...
			void GeometryFactoryAE::drawLine(const AE::Graphics::GeometryDescLine &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
			...
			void GeometryFactoryAE::drawPie(const AE::Graphics::GeometryDescPie &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
			...
			void GeometryFactoryAE::drawRectangle(const AE::Graphics::GeometryDescRectangle &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
			...
			void GeometryFactoryAE::drawSpline(const AE::Graphics::GeometryDescSpline &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
			...
			void GeometryFactoryAE::drawTriangle(const AE::Graphics::GeometryDescTriangle &geometryDesc)
			{
				assert(geometryDesc.drawingSurface);
